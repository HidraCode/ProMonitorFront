...
import { HomeOutlined, FileOutlined, BarsOutlined, BellOutlined, DeleteOutlined, TeamOutlined } from '@ant-design/icons';
...
const AlterarDadosAluno = () => {
  ...
  const sidemenuItems = [
    ...
    <SidemenuItem icon={<BarsOutlined />} label="Seleção" />
  ];
