...
const AnaliseCard = ({ nome, data, status, tipo, onClick }) => {
  return (
    <Row className='h-14 border-gray-300 border-y' onClick={onClick}>
      ...
      <Col span={5} className='flex items-center justify-center'>
        { tipo === 'frequencia' ?
          <div className='border-2 rounded-md text-[#52C41A] border-[#B7EB8F] bg-[#F6FFED] px-4'>Frequência</div> :
